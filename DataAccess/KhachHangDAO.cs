...
namespace DataAccess
{
    public class KhachHangDAO
    {
        ...
        public static string Register(KhachHangDTO dto)
        {
            ...
            string query = "insert into dbb49b543e1d5a4b4cad82a550004c76c4.account "
        ...
        {
            int maxid = 1;
            string query = "select * from dbb49b543e1d5a4b4cad82a550004c76c4.account ";
        ...
        public static KhachHangDTO GetAccountByID(string id)
        {
            ...
            string query = "select * from dbb49b543e1d5a4b4cad82a550004c76c4.account where ID like '" + id + "'";
        ...
        {
            string query = "update  dbb49b543e1d5a4b4cad82a550004c76c4.account set " + colname + " = '" + value + "' where ID like '" + id + "'";
